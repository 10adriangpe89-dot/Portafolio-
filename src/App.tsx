      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", width: "100%", position: "relative", zIndex: 1, paddingTop: "5rem" }}>
        ...
        <div style={{ ...s(0.3), display: "flex", gap: "1rem", flexWrap: "wrap", marginBottom: "3.5rem" }}>
          <a href="#projects" style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", background: "#00c9ff", color: "#000", padding: "0.85rem 2rem", borderRadius: 4, fontFamily: "'Syne', sans-serif", fontWeight: 700, fontSize: "0.83rem", letterSpacing: "0.05em", textDecoration: "none", textTransform: "uppercase", transition: "transform 0.2s, box-shadow 0.2s" }}
            onMouseEnter={e => { (e.currentTarget as HTMLAnchorElement).style.transform = "translateY(-2px)"; (e.currentTarget as HTMLAnchorElement).style.boxShadow = "0 8px 30px rgba(0,201,255,0.4)"; }}
          ...
          <a href="#contact" style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", border: "1px solid #1e2d45", color: "#d6e4ff", padding: "0.85rem 2rem", borderRadius: 4, fontFamily: "'Syne', sans-serif", fontWeight: 700, fontSize: "0.83rem", letterSpacing: "0.05em", textDecoration: "none", textTransform: "uppercase", transition: "border-color 0.2s, color 0.2s" }}
            onMouseEnter={e => { (e.currentTarget as HTMLAnchorElement).style.borderColor = "#00c9ff"; (e.currentTarget as HTMLAnchorElement).style.color = "#00c9ff"; }}
            onMouseLeave={e => { (e.currentTarget as HTMLAnchorElement).style.borderColor = "#1e2d45"; (e.currentTarget as HTMLAnchorElement).style.color = "#d6e4ff"; }}>
            Contactar
          </a>
        </div>
        ...
        >
          {SKILLS.map((sk) => (
            <div
              ...
              onMouseEnter={e => {
                (e.currentTarget as HTMLDivElement).style.background = "#161e2e";
                const bar = (e.currentTarget as HTMLDivElement).querySelector(".accent-bar") as HTMLDivElement | null;
        ...
        >
          {PROJECTS.map((p) => (
            <div
              ...
              onMouseEnter={e => (e.currentTarget as HTMLDivElement).style.background = "#161e2e"}
              onMouseLeave={e => (e.currentTarget as HTMLDivElement).style.background = "#0f1623"}
            >
              {/* Number */}
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            {[
              ...
              const base: React.CSSProperties = { display: "flex", alignItems: "center", gap: "1rem", padding: "1rem 1.2rem", border: "1px solid #1e2d45", borderRadius: 3, textDecoration: "none", transition: "border-color 0.2s", color: "inherit" };
              return href ? (
                <a key={label} href={href} style={base}
                  onMouseEnter={e => (e.currentTarget as HTMLAnchorElement).style.borderColor = "#00c9ff"}
                  onMouseLeave={e => (e.currentTarget as HTMLAnchorElement).style.borderColor = "#1e2d45"}>
                  {inner}
                </a>
              ) : (
        ...
        {[["#skills", "Habilidades"], ["#experience", "Experiencia"], ["#projects", "Proyectos"], ["#contact", "Contacto"]].map(([href, label]) => (
          <li key={href}>
            <a href={href} style={{ color: "#6b82a8", textDecoration: "none", fontSize: "0.72rem", letterSpacing: "0.1em", textTransform: "uppercase", transition: "color 0.2s", fontFamily: "'DM Mono', monospace" }}
              onMouseEnter={e => (e.currentTarget as HTMLAnchorElement).style.color = "#00c9ff"}
              onMouseLeave={e => (e.currentTarget as HTMLAnchorElement).style.color = "#6b82a8"}>
              {label}
            </a>
          </li>
        ))}
